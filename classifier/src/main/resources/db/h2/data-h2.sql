...
VALUES
  ...
  (2, 'GENERIC', 'DEF', 0, '2017-01-01 00:00:01.0'),
  (3, 'MKT', 'NTS', 0, '2017-01-01 00:00:01.0'),
  (4, 'OTP', 'TS', 0, '2017-01-01 00:00:01.0'),
  (5, 'SCAM', 'BLK', 0, '2017-01-01 00:00:01.0'),
...
VALUES
  ...
  (17, 4, NULL, NULL, '(.*)(vtre code)(.*)([0-9]{4, 8})(.*)', 0, '2017-01-01 00:00:01.0'),
  (18, 4, NULL, NULL, '(.*)(vtre code)(.*)([0-9]{4,8})(.*)', 1, '2017-02-01 00:00:01.0'),
  (19, 4, NULL, NULL, '(.*)(votre code)(.*)([0-9]{4,8})(.*)', 0, '2017-02-01 00:00:01.0');
-- ...